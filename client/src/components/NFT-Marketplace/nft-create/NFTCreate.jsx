      ...
      <div className="pt-4 pb-12 px-8">
        <form onSubmit={() => {}} className="w-full">
              ...
              <div className="space-y-1 text-center">
                ...
                <div className="flex items-center justify-center text-base">
                  <label htmlFor="file-upload" className="cursor-pointer rounded-md font-medium">
                    ...
                    <input id="file-upload" name="fileUpload" type="file" accept="image/*" className="sr-only" />
                  </label>
          ...
          <div className="w-full mt-10 flex items-center">
            <button className="text-white bg-[#1d4ed8] py-2 px-6 rounded-lg font-semibold hover:scale-110 transition-all ease-in-out duration-200">
              Create NFT
            </button>
          </div>
        </form>
